...
class MyWorkFlowListPage extends StatelessWidget {
  final bool myWorkFlow;

  const MyWorkFlowListPage({super.key, required this.myWorkFlow});
      ...
      child: Scaffold(
        ...
        floatingActionButton: Obx(() {
          return controller.workFlowResponseList.isNotEmpty
            ...
            onPressed: () {
              Get.bottomSheet(
                WorkflowFilterBottomSheet(myWorkFlow: true,),
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () => controller.viewWorkflow(item.documentWorkflowId),
                    icon: const Icon(
                      Icons.visibility,
                      size: 18,
                      color: Colors.green,
